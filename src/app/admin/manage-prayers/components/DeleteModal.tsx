...
export function DeleteModal({ prayer, onConfirm, onCancel, isPending }: DeleteModalProps) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-zinc-900 rounded-3xl p-8 w-full max-w-md shadow-2xl shadow-black/20">
                ...
                <h2 className="text-2xl font-black tracking-tight mb-2">Delete Prayer?</h2>
                <p className="text-zinc-500 font-medium mb-1">You are about to delete:</p>
