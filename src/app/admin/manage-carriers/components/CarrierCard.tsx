...
export function CarrierCard({ carrier, onSelect, onApprove, isApproving }: CarrierCardProps) {
    return (
        <motion.div
            layout
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <Badge
                                    className={`px-2 py-0 rounded-full text-[10px] font-black uppercase tracking-widest border-none flex-shrink-0 ${carrier.is_approved
                            ...
                            <div className="flex items-center gap-x-3 gap-y-0.5 flex-wrap text-xs font-medium text-zinc-400">
                                ...
                                <span className="text-rose-500 font-bold">{carrier.prayer_count} prayers</span>
                                <span className="hidden sm:inline text-zinc-300">•</span>
                                <span className="italic">Joined {format(new Date(carrier.date_joined), 'MMM d, yyyy')}</span>
                            </div>
                        </div>
                    </div>
