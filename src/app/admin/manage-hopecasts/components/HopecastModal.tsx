...
export function HopecastModal({ initial, categories, onSave, onClose, isPending }: HopecastModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSave({ title: title.trim(), mp4_link: mp4Link.trim(), categories: selectedCats });
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-zinc-900 rounded-3xl p-8 w-full max-w-lg shadow-2xl shadow-black/20 max-h-[90vh] overflow-y-auto">
                ...
                <p className="text-zinc-400 font-medium text-sm mb-8">
                    {initial ? 'Update the details below.' : 'Fill in the details to publish a new cast.'}
                </p>
                                ...
                                {categories.map((cat, idx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider border transition-all ${selected
