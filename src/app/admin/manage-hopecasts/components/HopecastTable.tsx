...
import { Radio, Play, Edit2, ExternalLink, Trash2, Tag, Plus } from 'lucide-react';
                ...
                <Table>
                    <TableHeader className="bg-zinc-50 dark:bg-zinc-800/50">
                        <TableRow className="hover:bg-transparent border-zinc-100 dark:border-zinc-800">
                            {['Title', 'Categories', 'Plays', 'Date Added', 'Actions'].map((h, i) => (
                                <TableHead
                                    key={h}
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <a
                                                ...
                                                className="text-xs text-brand hover:underline font-medium flex items-center gap-1 mt-0.5"
