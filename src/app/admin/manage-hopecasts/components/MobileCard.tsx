        ...
        <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm p-4 space-y-3">
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <p className="font-bold text-zinc-900 dark:text-zinc-100 leading-tight">{cast.title}</p>
                    <p className="text-xs text-zinc-400 font-medium mt-0.5">{formatDate(cast.created_at)}</p>
                </div>
            </div>
