  ...
  return (
    <div className="p-4 sm:p-8 lg:p-12 space-y-6 sm:space-y-10 max-w-7xl mx-auto">
      ...
      <header className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
        <div>
          <h1 className="text-3xl font-black italic tracking-tighter whitespace-nowrap">The Hope Desk</h1>
          <p className="text-zinc-500 font-medium text-sm">System-wide overview and live performance data.</p>
        </div>
      ...
      <div className="bg-brand rounded-3xl p-8 sm:p-12 text-brand-foreground flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black italic tracking-tight">Need Immediate Assistance?</h2>
          <p className="opacity-80 font-medium text-sm">Contact the technical support team or review active platform alerts.</p>
        </div>
